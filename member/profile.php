...
$page_title = 'Edit Profile - Dorve.id';
...
<div class="prof-wrapper">
    <aside class="prof-sidebar">
        ...
        <ul class="prof-nav">
            ...
            <li><a href="/member/profile.php" class="active">👤 Edit Profile</a></li>
    ...
    <main class="prof-content">
        <h1>👤 Edit Profile</h1>
        <p class="page-description">Update your personal information</p>
        ...
        <div class="form-card">
            <form method="POST">
                <div class="form-group">
                    ...
                    <small style="color: #6B7280; font-size: 13px; margin-top: 4px; display: block;">Email cannot be changed</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($user['phone'] ?? ''); ?>" placeholder="08123456789">
                </div>
